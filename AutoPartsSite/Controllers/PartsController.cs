...
namespace AutoPartsSite.Controllers
{
    ...
    {
        private AutoPartsDBEntities db = new AutoPartsDBEntities();
        ...
        public ActionResult SearchForPart(string autopartNumber)
        {
        ...
        public ActionResult SearchForParts(string autopartNumbers)
        {
